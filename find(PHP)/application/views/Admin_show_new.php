				...
				<div class="card-content col s12">
					...
					<ul class="collection with-header">
						...
						<li class="collection-header">
							<h4>
								<a href="<?php echo base_url()."admin/approve/".$row->shop_id; ?>" class="right btn bn-large">
									<i class="material-icons" >
										done
									</i>
								</a>
								<a href="<?php echo base_url()."admin/delete/".$row->shop_id; ?>" class="right btn bn-large">
									<i class="material-icons" >
										delete
									</i>
								</a>
						...
						<li class="collection-item">
							<div class="row">
								<h5>
									...
									<p class="col m9">
										: 
										<?php foreach($category as $row_cat) echo $row_cat->cat_name; ?>
									</p>
								</h5>
							</div>
						</li>
						...
						<li class="collection-item">
							<div class="row">
								<h5>
									...
									<p class="col m9">
										: 
										<?php echo date("d F,Y",strtotime($row->shop_start_date)); ?>
									</p>
								</h5>
							</div>
						</li>
